...
import org.nessus.didcomm.service.ENCRYPTED_ENVELOPE_V1
 ...
 */
class EncryptionEnvelopeV1: Protocol<EncryptionEnvelopeV1>(MessageExchange()) {
    override val log = KotlinLogging.logger {}

    override val protocolUri = ENCRYPTED_ENVELOPE_V1.uri

    companion object {
        val ENCRYPTED_ENVELOPE_V1_MEDIA_TYPE = "application/didcomm-envelope-enc; charset=utf-8".toMediaType()
    }
