...
import org.didcommx.didcomm.test.diddoc.DID_DOC_ALICE_WITH_NO_SECRETS
import org.didcommx.didcomm.test.diddoc.DID_DOC_BOB_SPEC_TEST_VECTORS
import org.didcommx.didcomm.test.diddoc.DID_DOC_BOB_WITH_NO_SECRETS
import org.didcommx.didcomm.test.diddoc.DID_DOC_CHARLIE
import org.didcommx.didcomm.test.diddoc.DID_DOC_ELLIE
...
class DIDDocResolverMockWithNoSecrets : DIDDocResolver {
    private val didDocResolver = DIDDocResolverInMemory(
        listOf(
